...
export class TickerTask {
    public emitter: EventEmitter<TickerTaskEvents> = new EventEmitter();
    public speed: number;
...
export class Ticker {
    ...
    private _callbacks: Array<TickerCallback>;
    ...
    public remove(callback: TickerCallback): void {
    ...
    public addTask(config: ITickerTaskConfig): TickerTask {
        ...
        task.emitter.on('complete', this.removeTask);
        task.emitter.on('dispose', this.removeTask);
